...
- **造影剤注入後およそ30秒後**からScan Start
- Dynamic撮像時、乳房が大きい場合は**枚数を増やさず、スライス厚を調整**する（1相の時間が変わらないようにする）
...
:::warning
- TRAの撮像範囲はインプラントだけでなく**両乳房を含めて**撮像
- SAGの撮像範囲は**乳房インプラントのみ**撮像
- 両乳房インプラントの場合は両方含める
:::
