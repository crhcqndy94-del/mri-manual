...
:::info
- 肝臓の撮像では**gapは0**に設定している
- DWI横隔膜同期が上手く撮れない場合は**呼吸同期シーケンスを使用**しても可
:::
...
- 2相目：1相目終了から**30秒後**に撮像
- 3相目：造影注入後**180秒後**に撮像
- 肝細胞相：**造影剤が総胆管に排泄されていれば**撮像
:::

:::warning
- Dynamicは息止め時間を短く設定しているが、息止めができない場合は撮像時間を短くする
- DELAY CORが上手く撮像できない場合は**ENCAGEを使用**。ただし撮像範囲は躯幹部を必ず含める
